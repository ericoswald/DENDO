    ...
    <div class="contact_conteneur">
        ...
        <form class="form_contact" action="#" method="POST">
            ...
            <div class="contact_form">
                ...
                <input class="contact_espace_form" type="text" name="nom" value="" placeholder="Votre nom"
                       required>


                <input class="contact_espace_form" type="text" name="prenom" value="" placeholder="Votre prenom"
                       required>
